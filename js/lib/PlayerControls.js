...
THREE.PlayerControls = function ( camera, player, domElement ) {
	...
	this.center = new THREE.Vector3( this.player.position.x, this.player.position.y, this.player.position.z );
	...
	var lastPosition = new THREE.Vector3( this.player.position.x, this.player.position.y, this.player.position.z );
	...
	this.init = function() {
		...
		this.camera.position.x = this.player.position.x + this.zoomDistance;
		this.camera.position.y = this.player.position.y + this.zoomDistance;
		this.camera.position.z = this.player.position.x + this.zoomDistance;
	...
	this.update = function() { 
		...
		if ( this.autoRotate ) {
			...
			this.camera.position.x += this.autoRotateSpeed * ( ( this.player.position.x + this.zoomDistance * Math.sin( this.player.rotation.y ) ) - this.camera.position.x );
			this.camera.position.z += this.autoRotateSpeed * ( ( this.player.position.z + this.zoomDistance * Math.cos( this.player.rotation.y ) ) - this.camera.position.z );
	...
	this.checkKeyStates = function () {
	    ...
	    if ( playerIsMoving ) {
	    	firebase.child( "Users" ).child( username ).child( "Action" ).update( {
	    		position: {
